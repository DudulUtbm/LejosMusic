...
public class LauncherFollower {
	...
	public static void main(String[] args) throws IOException {
		...
		final Track violin1 = trackReader.read(LauncherFollower.class.getResourceAsStream("/lejos/music/samples/score01/violin1.txt"));
		final Track violin2 = trackReader.read(LauncherFollower.class.getResourceAsStream("/lejos/music/samples/score01/violin2.txt"));
		final Track violoncello = trackReader.read(LauncherFollower.class.getResourceAsStream("/lejos/music/samples/score01/violoncello.txt"));
		final Track contrabass = trackReader.read(LauncherFollower.class.getResourceAsStream("/lejos/music/samples/score01/contrabass.txt"));
